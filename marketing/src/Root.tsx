...
const defaultStatsProps: StatsUpdateProps = {
  ...
  stats: [
    { value: "$38,564+", numericValue: 38564, prefix: "$", suffix: "+", label: "USD1 Distributed", color: "#00ff88" },
    { value: "700+", numericValue: 700, suffix: "+", label: "Distribution Cycles", color: "#00d4ff" },
